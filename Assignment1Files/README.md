...
head -n 1 fang_et_al_genotypes.txt 
head -n 1 fang_et_al_genotypes.txt > maise_genotypes.txt

used awk to select only stuff that had the specific groups from fangetal to get maise and teosinte genotypes

awk '$3=="ZMMIL" || $3=="ZMMLR" || $3=="ZMMMR"' fang_et_al_genotypes.txt >> maise_genotypes.txt
vi maise_genotypes.txt 
...
vi teosinte_genotypes.txt 
vi transpose.awk 
vi cut_snp.txt 
vi maise_genotypes.txt 

awk -f transpose.awk teosinte_genotypes.txt > transposed_teosinte_genotypes.txt
awk -f transpose.awk maise_genotypes.txt > transposed_maise_genotypes.txt


cut snp_positions to get only columns 1 3 and 4:

vi snp_position.txt 
cut -f 1,3,4 snp_position.txt 
...
grep "ZMMIL" transposed_genotypes.txt 
grep -w "ZMMIL" transposed_genotypes.txt 
grep "ZMMIL" -w transposed_genotypes.txt 
grep ZMMIL transposed_genotypes.txt 
grep -v ZMMIL transposed_genotypes.txt 
...
sort cut_snp.txt | head -n 5
head -n 1 cut_snp.txt > header_snp.txt
head -n 1 teosinte_genotypes.txt > header_teosinte.txt

join -1 1 -2 1 header_snp.txt header_teosinte.txt > header.txt
head -n 1 transposed_teosinte_genotypes.txt > header_teosinte.txt
join -1 1 -2 1 header_snp.txt header_teosinte.txt > header.txt
join -1 1 -2 1 header_snp.txt header_teosinte.txt > header.txt
join -1 1 -2 1 header_snp.txt header_teosinte.txt > header.txt

sort transposed_teosinte_genotypes.txt > sorted_teosinte_genotypes.txt
sort cut_snp.txt > sorted_snp.txt

join -1 1 -2 1 sorted_snp.txt sorted_teosinte_genotypes.txt > joined_teosinte.txt
sort -k1 transposed_teosinte_genotypes.txt > sorted_teosinte_genotypes.txt

sort -k1 cut_snp.txt > sorted_snp.txt 
join -1 1 -2 1 sorted_snp.txt sorted_teosinte_genotypes.txt > joined_teosinte.txt

join -1 1 -2 1 -i sorted_snp.txt sorted_teosinte_genotypes.txt > joined_teosinte.txt

check the joined teosinte, cut snp, and sorted snp:

vi joined_teosinte.txt 
vi cut_snp.txt 
vi sorted_snp.txt 

sorted them with k1,1...

sort -k1,1 -k2,2n cut_snp.txt > sorted_snp.txt 
sort -k1,1 transposed_teosinte_genotypes.txt > sorted_teosinte_genotypes.txt
join -1 1 -2 1 -i sorted_snp.txt sorted_teosinte_genotypes.txt > joined_teosinte.txt
sort -k1 transposed_teosinte_genotypes.txt > test.txt

display the differences in the files by comparing the files line by line:

diff test.txt sorted_teosinte_genotypes.txt 

sort:

sort -k1,1 cut_snp.txt > sorted_snp.txt 
sort -k1,1 transposed_teosinte_genotypes.txt > sorted_teosinte_genotypes.txt
...
cat header.txt > final_teosinte.txt
cat joined_teosinte.txt >> final_teosinte.txt 

Sort the transposed maize genotypes and join them:

sort -k1,1 transposed_maise_genotypes.txt > sorted_maise_genotypes.txt
join -1 1 -2 1 -i sorted_snp.txt sorted_maise_genotypes.txt > joined_maise.txt

add the header to final one:

cat header.txt > final_maise.txt
cat joined_maise.txt >> final_maise.txt
...
awk '$3=="unknown"' final_teosinte.txt > SNP_unknown_positions_teosinte.txt
awk '$3=="multiple"' final_teosinte.txt  > SNP_multiple_positions_teosinte.txt

Then did the same for maize:

awk '$3=="unknown"' final_maise.txt > SNP_unknown_positions_maise.txt
awk '$3=="multiple"' final_maise.txt > SNP_multiple_positions_maise.txt

To make 10 files for teosinte, 1 for each chromosome, with SNPs ordered in increasing position with missing data with ?:

awk '$2==1' final_teosinte.txt | sort -k3,3 > chromosome1_SNP_increasing_pos_teosinte.txt
awk '$2==2' final_teosinte.txt | sort -k3,3 > chromosome2_SNP_increasing_pos_teosinte.txt
awk '$2==3' final_teosinte.txt | sort -k3,3 > chromosome3_SNP_increasing_pos_teosinte.txt
awk '$2==4' final_teosinte.txt | sort -k3,3 > chromosome4_SNP_increasing_pos_teosinte.txt
awk '$2==5' final_teosinte.txt | sort -k3,3 > chromosome5_SNP_increasing_pos_teosinte.txt
awk '$2==6' final_teosinte.txt | sort -k3,3 > chromosome6_SNP_increasing_pos_teosinte.txt
awk '$2==7' final_teosinte.txt | sort -k3,3 > chromosome7_SNP_increasing_pos_teosinte.txt
awk '$2==8' final_teosinte.txt | sort -k3,3 > chromosome8_SNP_increasing_pos_teosinte.txt
awk '$2==9' final_teosinte.txt | sort -k3,3 > chromosome9_SNP_increasing_pos_teosinte.txt
awk '$2==10' final_teosinte.txt | sort -k3,3 > chromosome10_SNP_increasing_pos_teosinte.txt
...
sort -r -k3,3 chromosome1_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome1_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome2_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome2_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome3_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome3_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome4_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome4_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome5_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome5_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome6_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome6_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome7_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome7_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome8_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome8_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome9_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome9_SNP_decreasing_pos_teosinte.txt
sort -r -k3,3 chromosome10_SNP_increasing_pos_teosinte.txt | sed 's/?/-/g' > chromosome10_SNP_decreasing_pos_teosinte.txt

To make 10 files for maize, 1 for each chromosome, with SNPs ordered in increasing position with missing data with ?:

awk '$2==1' final_maise.txt | sort -k3,3 > chromosome1_SNP_increasing_pos_maize.txt
awk '$2==2' final_maise.txt | sort -k3,3 > chromosome2_SNP_increasing_pos_maize.txt
awk '$2==3' final_maise.txt | sort -k3,3 > chromosome3_SNP_increasing_pos_maize.txt
awk '$2==4' final_maise.txt | sort -k3,3 > chromosome4_SNP_increasing_pos_maize.txt
awk '$2==5' final_maise.txt | sort -k3,3 > chromosome5_SNP_increasing_pos_maize.txt
awk '$2==6' final_maise.txt | sort -k3,3 > chromosome6_SNP_increasing_pos_maize.txt
awk '$2==7' final_maise.txt | sort -k3,3 > chromosome7_SNP_increasing_pos_maize.txt
awk '$2==8' final_maise.txt | sort -k3,3 > chromosome8_SNP_increasing_pos_maize.txt
awk '$2==9' final_maise.txt | sort -k3,3 > chromosome9_SNP_increasing_pos_maize.txt
awk '$2==10' final_maise.txt | sort -k3,3 > chromosome10_SNP_increasing_pos_maize.txt

To make 10 more files for maize, 1 for each chromosome, with SNPs ordered in decreasing position with missing data with a - :


sort -r -k3,3 chromosome1_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome1_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome2_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome2_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome3_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome3_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome4_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome4_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome5_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome5_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome6_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome6_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome7_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome7_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome8_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome8_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome9_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome9_SNP_decreasing_pos_maize.txt
sort -r -k3,3 chromosome10_SNP_increasing_pos_maize.txt | sed 's/?/-/g' > chromosome10_SNP_decreasing_pos_maize.txt
